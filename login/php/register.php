...
function validateData($username, $password, $email, $phoneNumber) {
    $errors = array();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Kiểm tra dữ liệu
    $errors = validateData($username, $password, $email, $phoneNumber);
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO `tbl_users` (`username`, `password`, `email`, `phoneNumber`) VALUES ('$username', '$hashedPassword', '$email', '$phoneNumber') ";
